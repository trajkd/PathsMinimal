...
public class ImageClickFromGallery : MonoBehaviour
{
    ...
    public void OnClick()
    {
        if (!zoomed) {
            ...
            originalTransform = transform.parent.gameObject.transform;
    ...
    public void OnBackClick() {
        ...
        LeanTween.move(theImage, originalTransform, 0.2f).setIgnoreTimeScale(true);
        theImage.GetComponent<Image>().preserveAspect = false;
        ...
        zoomed = false;
        StartCoroutine(WaitForImageResize());
    }
    IEnumerator WaitForImageResize() {
